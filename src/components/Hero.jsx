...
const Hero = () => {
  ...
  <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
    <h1 className="h1 mb-6 leading-[1.2] sm:leading-[1.4] flex flex-col items-center">
      <span className="block">Unlock the Power of</span>
      <span className="block">Effortless Crypto Trading with</span>
      <span className="inline-block relative mt-2">
        ...
        />
          ...
          with real-time market insights and user-friendly platform 
            ...
            <Button href="https://crypto-accessnew.vercel.app/" white>
              Get started
            </Button>
        </div>
